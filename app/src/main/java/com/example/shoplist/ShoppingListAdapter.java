...
public class ShoppingListAdapter extends RecyclerView.Adapter<ShoppingListAdapter.ShoppingListViewHolder> implements RenameListDialogue.RenameListDialogueListener {
    ...
    public void renameList(String listTitle) {
        shoppingList.get(listPosition).title = listTitle;
